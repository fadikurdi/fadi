...
<html lang="en" class="no-js">
    ...
    <body id="body" data-spy="scroll" data-target=".header">
                    ...
                    <div class="menu-container js_nav-item">
                        ...
                        <div class="logo">
                            <a class="logo-wrap" href="#body">
                                <img class="logo-img logo-img-main" src="img/Buzz2.png" alt="Buzz1.gif">
                                <img class="logo-img logo-img-active" src="img/Buzz2.png" alt="Buzz1">
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
        ...
        <!--========== SLIDER ==========-->
        <div class="promo-block parallax-window" data-parallax="scroll" data-image-src="img/fadi3.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="promo-block-divider">
                            <h1 class="promo-block-title">Fadi <br/> Kurdi</h1>
                            <p class="promo-block-text"> Front-end Developer</p>
                        </div>
                        <ul class="list-inline">
                            <li><a href="https://www.facebook.com/fadi.kurdi1" class="social-icons"><i class="icon-social-facebook"></i></a></li>
                            <li><a href="https://twitter.com/fadikurdi" class="social-icons"><i class="icon-social-twitter"></i></a></li>
                            <li><a href="https://www.linkedin.com/feed/" class="social-icons"><i class="icon-social-linkedin"></i></a></li>
                        </ul>
                    </div>
                </div>
                <!--// end row -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-sm-offset-1">
                        <div class="margin-b-60">
                            <p>Hi there ,I'm Fadi Kurdi 24 years old, Syrian who lives in the Netherlands for almost two years now . 
                            front-end Developer at Re-Start Network ... coding is the only thing that would makes you nervous and simply one click and you will be happy again.   </p>
                        ...
                        <div class="progress-box">
                            <h5>CSS <span class="color-heading pull-right">80%</span></h5>
                            <div class="progress">
                                <div class="progress-bar bg-color-base" role="progressbar" data-width="87"></div>
                            </div>
                        </div>
                        <div class="progress-box">
                            <h5>HTML5 <span class="color-heading pull-right">90%</span></h5>
                            <div class="progress">
                            ...
                            <div class="row row-space-2 margin-b-4">
                                <div class="col-md-4 md-margin-b-4">
                                    <div class="service" data-height="height">
                                        ...
                                        <div class="service-info">
                                            <h3>HTML5/CSS3</h3>
                                            <p class="margin-b-5">i Just love it   </p>
                                        </div>
                                        <a href="https://restart.network/" class="content-wrapper-link"></a>    
                                    </div>
                                </div>
                                <div class="col-md-4 md-margin-b-4">
                                    <div class="service bg-color-base wow zoomIn" data-height="height" data-wow-duration=".3" data-wow-delay=".1s">
                                        ...
                                        <div class="service-info">
                                            ...
                                            <p class="color-white margin-b-5">pay attention to the beauty around you always</p>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="service" data-height="height">
                                        ...
                                        <div class="service-info">
                                            <h3>Front-end</h3>
                                            <p class="margin-b-5">at RE/Start-Network</p>
                                        </div>
                                        <a href="https://restart.network/" class="content-wrapper-link"></a>    
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-8 col-sm-offset-1">
                            <div class="row">
                                <div class="col-md-3 col-xs-6 md-margin-b-30">
                                    <h5>Location</h5>
                                    <a href="#">Van Meekerenstraat 98b,Rotterdam 3034GD,<br>Netherlands</a>
                                </div>
                                <div class="col-md-3 col-xs-6 md-margin-b-30">
                                    <h5>Phone</h5>
                                    <a href="#">06 86 435 253</a>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <h5>Email</h5>
                                    <a href="mailto:#">fadikurdi00@gmail.com</a>
                                </div>
        ...
        <footer class="footer">
            <div class="content container">
                <div class="row">
                    <div class="col-xs-6">
                        <img class="footer-logo" src="img/Buzz.gif" alt="Aircv Logo">
                    </div>
